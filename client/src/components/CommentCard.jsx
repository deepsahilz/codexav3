...
const CommentCard = ({comment}) => {
    ...
    const getReplies=async(parentId)=>{
        ...
        try{
            // const data = axiosInstance.get("/api/comment/:parentId/replies")
  ...
  return (
    <div className='rounded-lg bg-white border py-3 px-7 font-nb'>
        <div className='flex items-start gap-3 '>
            <div className="w-8 h-8 mt-2 rounded-full overflow-hidden ">
                <Avatar username={comment.username} avatar_url={comment.avatar}/>
            </div>
